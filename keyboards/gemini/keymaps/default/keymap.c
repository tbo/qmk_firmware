...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
     ...
     KC_MPLY ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,                          KC_N    ,KC_M    ,KC_COMM ,KC_DOT  ,KC_SLSH ,KC_VOLD ,
                       KC_MPRV ,KC_MINS ,KC_EQL  ,KC_NO   ,MT(MOD_LSFT, KC_SPC),     MT(MOD_LGUI, KC_ESC), KC_NO  ,KC_LBRC ,KC_RBRC ,KC_MNXT
    )
};
